...
@NamedQueries({
    ...
    @NamedQuery(name = "Measure.findByCaseId", query = "SELECT m FROM Measure m WHERE m.caseId = :caseId"),
    @NamedQuery(name = "Measure.findByTotal", query = "SELECT m FROM Measure m WHERE m.total = :total"),
    @NamedQuery(name = "Measure.findByCustomerid", query = "SELECT m FROM Measure m WHERE m.customerid = :customerid"),
    @NamedQuery(name = "Measure.findByNumber1insulatatticblownche", query = "SELECT m FROM Measure m WHERE m.number1insulatatticblownche = :number1insulatatticblownche"),
    @NamedQuery(name = "Measure.findByNumber1insulatatticblownstring", query = "SELECT m FROM Measure m WHERE m.number1insulatatticblownstring = :number1insulatatticblownstring"),
    @NamedQuery(name = "Measure.findBySqft1", query = "SELECT m FROM Measure m WHERE m.sqft1 = :sqft1"),
    @NamedQuery(name = "Measure.findByNumber1insulatatticblownresult", query = "SELECT m FROM Measure m WHERE m.number1insulatatticblownresult = :number1insulatatticblownresult"),
    @NamedQuery(name = "Measure.findByNumber2removeandreplaceche", query = "SELECT m FROM Measure m WHERE m.number2removeandreplaceche = :number2removeandreplaceche"),
    @NamedQuery(name = "Measure.findBySqft2", query = "SELECT m FROM Measure m WHERE m.sqft2 = :sqft2"),
    @NamedQuery(name = "Measure.findByNumber2removeandreplaceresult", query = "SELECT m FROM Measure m WHERE m.number2removeandreplaceresult = :number2removeandreplaceresult"),
    @NamedQuery(name = "Measure.findByNumber3installbattedinionche", query = "SELECT m FROM Measure m WHERE m.number3installbattedinionche = :number3installbattedinionche"),
    @NamedQuery(name = "Measure.findBySqft3", query = "SELECT m FROM Measure m WHERE m.sqft3 = :sqft3"),
    @NamedQuery(name = "Measure.findByNumber3installbattedinresult", query = "SELECT m FROM Measure m WHERE m.number3installbattedinresult = :number3installbattedinresult"),
    @NamedQuery(name = "Measure.findByNumber4sealductingcodcheckbox", query = "SELECT m FROM Measure m WHERE m.number4sealductingcodcheckbox = :number4sealductingcodcheckbox"),
    @NamedQuery(name = "Measure.findByNumber4sealductingcodecstring", query = "SELECT m FROM Measure m WHERE m.number4sealductingcodecstring = :number4sealductingcodecstring"),
    @NamedQuery(name = "Measure.findBySqft4", query = "SELECT m FROM Measure m WHERE m.sqft4 = :sqft4"),
    @NamedQuery(name = "Measure.findByNumber4sealductingcoderesult", query = "SELECT m FROM Measure m WHERE m.number4sealductingcoderesult = :number4sealductingcoderesult"),
    @NamedQuery(name = "Measure.findBySqft5", query = "SELECT m FROM Measure m WHERE m.sqft5 = :sqft5"),
    @NamedQuery(name = "Measure.findByNumber5airsealpcheckbox", query = "SELECT m FROM Measure m WHERE m.number5airsealpcheckbox = :number5airsealpcheckbox"),
    @NamedQuery(name = "Measure.findByNumber5airsealstring", query = "SELECT m FROM Measure m WHERE m.number5airsealstring = :number5airsealstring"),
    @NamedQuery(name = "Measure.findByNumber5airsealparesult", query = "SELECT m FROM Measure m WHERE m.number5airsealparesult = :number5airsealparesult"),
    @NamedQuery(name = "Measure.findBySqft6", query = "SELECT m FROM Measure m WHERE m.sqft6 = :sqft6"),
    @NamedQuery(name = "Measure.findByNumber6cazarearecheckbox", query = "SELECT m FROM Measure m WHERE m.number6cazarearecheckbox = :number6cazarearecheckbox"),
    @NamedQuery(name = "Measure.findByNumber6cazareatstring", query = "SELECT m FROM Measure m WHERE m.number6cazareatstring = :number6cazareatstring"),
    @NamedQuery(name = "Measure.findByNumber6cazarearesult", query = "SELECT m FROM Measure m WHERE m.number6cazarearesult = :number6cazarearesult"),
    @NamedQuery(name = "Measure.findBySqft7a", query = "SELECT m FROM Measure m WHERE m.sqft7a = :sqft7a"),
    @NamedQuery(name = "Measure.findByNumber7ainstallductingcheckbox", query = "SELECT m FROM Measure m WHERE m.number7ainstallductingcheckbox = :number7ainstallductingcheckbox"),
    @NamedQuery(name = "Measure.findByNumber7ainstallductingstring", query = "SELECT m FROM Measure m WHERE m.number7ainstallductingstring = :number7ainstallductingstring"),
    @NamedQuery(name = "Measure.findByNumber7ainstallductingresult", query = "SELECT m FROM Measure m WHERE m.number7ainstallductingresult = :number7ainstallductingresult"),
    @NamedQuery(name = "Measure.findBySqft7b", query = "SELECT m FROM Measure m WHERE m.sqft7b = :sqft7b"),
    @NamedQuery(name = "Measure.findByNumber7binstallr8ducheckbox", query = "SELECT m FROM Measure m WHERE m.number7binstallr8ducheckbox = :number7binstallr8ducheckbox"),
    @NamedQuery(name = "Measure.findByNumber7binstallr8ductstring", query = "SELECT m FROM Measure m WHERE m.number7binstallr8ductstring = :number7binstallr8ductstring"),
    @NamedQuery(name = "Measure.findByNumber7binstallr8ductresult", query = "SELECT m FROM Measure m WHERE m.number7binstallr8ductresult = :number7binstallr8ductresult"),
    @NamedQuery(name = "Measure.findBySqft8a", query = "SELECT m FROM Measure m WHERE m.sqft8a = :sqft8a"),
    @NamedQuery(name = "Measure.findByNumber8anewhvacicheckbox", query = "SELECT m FROM Measure m WHERE m.number8anewhvacicheckbox = :number8anewhvacicheckbox"),
    @NamedQuery(name = "Measure.findByNumber8anewhvacstring", query = "SELECT m FROM Measure m WHERE m.number8anewhvacstring = :number8anewhvacstring"),
    @NamedQuery(name = "Measure.findByNumber8anewhvaresult", query = "SELECT m FROM Measure m WHERE m.number8anewhvaresult = :number8anewhvaresult"),
    @NamedQuery(name = "Measure.findBySqft8b", query = "SELECT m FROM Measure m WHERE m.sqft8b = :sqft8b"),
    @NamedQuery(name = "Measure.findByNumber8bnewhvacsycheckbox", query = "SELECT m FROM Measure m WHERE m.number8bnewhvacsycheckbox = :number8bnewhvacsycheckbox"),
    @NamedQuery(name = "Measure.findByNumber8bnewhvacsysstring", query = "SELECT m FROM Measure m WHERE m.number8bnewhvacsysstring = :number8bnewhvacsysstring"),
    @NamedQuery(name = "Measure.findByNumber8bnewhvacsyresult", query = "SELECT m FROM Measure m WHERE m.number8bnewhvacsyresult = :number8bnewhvacsyresult"),
    @NamedQuery(name = "Measure.findBySqft8bii", query = "SELECT m FROM Measure m WHERE m.sqft8bii = :sqft8bii"),
    @NamedQuery(name = "Measure.findByNumber8biiincludecheckbox", query = "SELECT m FROM Measure m WHERE m.number8biiincludecheckbox = :number8biiincludecheckbox"),
    @NamedQuery(name = "Measure.findByNumber8biiincludestring", query = "SELECT m FROM Measure m WHERE m.number8biiincludestring = :number8biiincludestring"),
    @NamedQuery(name = "Measure.findByNumber8biiincludresult", query = "SELECT m FROM Measure m WHERE m.number8biiincludresult = :number8biiincludresult"),
    @NamedQuery(name = "Measure.findBySqft9", query = "SELECT m FROM Measure m WHERE m.sqft9 = :sqft9"),
    @NamedQuery(name = "Measure.findByNumber9singledualzcheckbox", query = "SELECT m FROM Measure m WHERE m.number9singledualzcheckbox = :number9singledualzcheckbox"),
    @NamedQuery(name = "Measure.findByNumber9singledualzostring", query = "SELECT m FROM Measure m WHERE m.number9singledualzostring = :number9singledualzostring"),
    @NamedQuery(name = "Measure.findByNumber9singledresult", query = "SELECT m FROM Measure m WHERE m.number9singledresult = :number9singledresult"),
    @NamedQuery(name = "Measure.findBySqft91", query = "SELECT m FROM Measure m WHERE m.sqft91 = :sqft91"),
    @NamedQuery(name = "Measure.findByNumber91arelocheckbox", query = "SELECT m FROM Measure m WHERE m.number91arelocheckbox = :number91arelocheckbox"),
    @NamedQuery(name = "Measure.findByNumber91areloint", query = "SELECT m FROM Measure m WHERE m.number91areloint = :number91areloint"),
    @NamedQuery(name = "Measure.findByNumber91arelocresult", query = "SELECT m FROM Measure m WHERE m.number91arelocresult = :number91arelocresult"),
    @NamedQuery(name = "Measure.findByNumber91bcutinsupplyvcheckbox", query = "SELECT m FROM Measure m WHERE m.number91bcutinsupplyvcheckbox = :number91bcutinsupplyvcheckbox"),
    @NamedQuery(name = "Measure.findByNumber91bcutinsupplyint", query = "SELECT m FROM Measure m WHERE m.number91bcutinsupplyint = :number91bcutinsupplyint"),
    @NamedQuery(name = "Measure.findByNumber91bcutinsupplyvresult", query = "SELECT m FROM Measure m WHERE m.number91bcutinsupplyvresult = :number91bcutinsupplyvresult"),
    @NamedQuery(name = "Measure.findByNumber91chcheckbox", query = "SELECT m FROM Measure m WHERE m.number91chcheckbox = :number91chcheckbox"),
    @NamedQuery(name = "Measure.findByNumber91chvaint", query = "SELECT m FROM Measure m WHERE m.number91chvaint = :number91chvaint"),
    @NamedQuery(name = "Measure.findByNumber91chvaccutinresult", query = "SELECT m FROM Measure m WHERE m.number91chvaccutinresult = :number91chvaccutinresult"),
    @NamedQuery(name = "Measure.findByNumber91dducheckbox", query = "SELECT m FROM Measure m WHERE m.number91dducheckbox = :number91dducheckbox"),
    @NamedQuery(name = "Measure.findByNumber91dducint", query = "SELECT m FROM Measure m WHERE m.number91dducint = :number91dducint"),
    @NamedQuery(name = "Measure.findByNumber91dductresult", query = "SELECT m FROM Measure m WHERE m.number91dductresult = :number91dductresult"),
    @NamedQuery(name = "Measure.findByNumber91enecheckbox", query = "SELECT m FROM Measure m WHERE m.number91enecheckbox = :number91enecheckbox"),
    @NamedQuery(name = "Measure.findByNumber91eneint", query = "SELECT m FROM Measure m WHERE m.number91eneint = :number91eneint"),
    @NamedQuery(name = "Measure.findByNumber91eneresult", query = "SELECT m FROM Measure m WHERE m.number91eneresult = :number91eneresult"),
    @NamedQuery(name = "Measure.findByNumber91fenlacheckbox", query = "SELECT m FROM Measure m WHERE m.number91fenlacheckbox = :number91fenlacheckbox"),
    @NamedQuery(name = "Measure.findByNumber91fenlargint", query = "SELECT m FROM Measure m WHERE m.number91fenlargint = :number91fenlargint"),
    @NamedQuery(name = "Measure.findByNumber91fenlargerresult", query = "SELECT m FROM Measure m WHERE m.number91fenlargerresult = :number91fenlargerresult"),
    @NamedQuery(name = "Measure.findByNumber92notescheckbox", query = "SELECT m FROM Measure m WHERE m.number92notescheckbox = :number92notescheckbox"),
    @NamedQuery(name = "Measure.findByNumber92notesstring", query = "SELECT m FROM Measure m WHERE m.number92notesstring = :number92notesstring"),
    @NamedQuery(name = "Measure.findByNumber93costperkwcheckbox", query = "SELECT m FROM Measure m WHERE m.number93costperkwcheckbox = :number93costperkwcheckbox"),
    @NamedQuery(name = "Measure.findByNumber93costperkwint", query = "SELECT m FROM Measure m WHERE m.number93costperkwint = :number93costperkwint"),
    @NamedQuery(name = "Measure.findByNumber93costperkwresalt", query = "SELECT m FROM Measure m WHERE m.number93costperkwresalt = :number93costperkwresalt"),
    @NamedQuery(name = "Measure.findByNumber93dckwsint", query = "SELECT m FROM Measure m WHERE m.number93dckwsint = :number93dckwsint"),
    @NamedQuery(name = "Measure.findByNumber93dckwsresalt", query = "SELECT m FROM Measure m WHERE m.number93dckwsresalt = :number93dckwsresalt"),
    @NamedQuery(name = "Measure.findByNumber10installwindowscheckbox", query = "SELECT m FROM Measure m WHERE m.number10installwindowscheckbox = :number10installwindowscheckbox"),
    @NamedQuery(name = "Measure.findByNumber10numofwindows", query = "SELECT m FROM Measure m WHERE m.number10numofwindows = :number10numofwindows"),
    @NamedQuery(name = "Measure.findByNumber10totalunitedinchesint", query = "SELECT m FROM Measure m WHERE m.number10totalunitedinchesint = :number10totalunitedinchesint"),
    @NamedQuery(name = "Measure.findByNumber10installresult", query = "SELECT m FROM Measure m WHERE m.number10installresult = :number10installresult"),
    @NamedQuery(name = "Measure.findByNumber10numofsliders", query = "SELECT m FROM Measure m WHERE m.number10numofsliders = :number10numofsliders"),
    @NamedQuery(name = "Measure.findByNumber10linearfeet", query = "SELECT m FROM Measure m WHERE m.number10linearfeet = :number10linearfeet"),
    @NamedQuery(name = "Measure.findByNumber10linearfeetresult", query = "SELECT m FROM Measure m WHERE m.number10linearfeetresult = :number10linearfeetresult"),
    @NamedQuery(name = "Measure.findByNumber101acutindoorcheckbox", query = "SELECT m FROM Measure m WHERE m.number101acutindoorcheckbox = :number101acutindoorcheckbox"),
    @NamedQuery(name = "Measure.findByNumber101acutindoorint", query = "SELECT m FROM Measure m WHERE m.number101acutindoorint = :number101acutindoorint"),
    @NamedQuery(name = "Measure.findByNumber101acutindoorresult", query = "SELECT m FROM Measure m WHERE m.number101acutindoorresult = :number101acutindoorresult"),
    @NamedQuery(name = "Measure.findByNumber101baddheadercheckbox", query = "SELECT m FROM Measure m WHERE m.number101baddheadercheckbox = :number101baddheadercheckbox"),
    @NamedQuery(name = "Measure.findByNumber101baddheaderint", query = "SELECT m FROM Measure m WHERE m.number101baddheaderint = :number101baddheaderint"),
    @NamedQuery(name = "Measure.findByNumber101baddheaderresult", query = "SELECT m FROM Measure m WHERE m.number101baddheaderresult = :number101baddheaderresult"),
    @NamedQuery(name = "Measure.findByNumber102acutdowncheckbox", query = "SELECT m FROM Measure m WHERE m.number102acutdowncheckbox = :number102acutdowncheckbox"),
    @NamedQuery(name = "Measure.findByNumber102acutdownwiresult", query = "SELECT m FROM Measure m WHERE m.number102acutdownwiresult = :number102acutdownwiresult"),
    @NamedQuery(name = "Measure.findByNumber102belectricalcheckbox", query = "SELECT m FROM Measure m WHERE m.number102belectricalcheckbox = :number102belectricalcheckbox"),
    @NamedQuery(name = "Measure.findByNumber102belectricalreresult", query = "SELECT m FROM Measure m WHERE m.number102belectricalreresult = :number102belectricalreresult"),
    @NamedQuery(name = "Measure.findByNumber102cgardencheckbox", query = "SELECT m FROM Measure m WHERE m.number102cgardencheckbox = :number102cgardencheckbox"),
    @NamedQuery(name = "Measure.findByNumber102cgardenresult", query = "SELECT m FROM Measure m WHERE m.number102cgardenresult = :number102cgardenresult"),
    @NamedQuery(name = "Measure.findByNumber102dgardenwicheckbox", query = "SELECT m FROM Measure m WHERE m.number102dgardenwicheckbox = :number102dgardenwicheckbox"),
    @NamedQuery(name = "Measure.findByNumber102dgardenwiresult", query = "SELECT m FROM Measure m WHERE m.number102dgardenwiresult = :number102dgardenwiresult"),
    @NamedQuery(name = "Measure.findByNumber103allglazingcheckbox", query = "SELECT m FROM Measure m WHERE m.number103allglazingcheckbox = :number103allglazingcheckbox"),
    @NamedQuery(name = "Measure.findByNumber104wicheckbox", query = "SELECT m FROM Measure m WHERE m.number104wicheckbox = :number104wicheckbox"),
    @NamedQuery(name = "Measure.findByNumber11installpoolcheckbox", query = "SELECT m FROM Measure m WHERE m.number11installpoolcheckbox = :number11installpoolcheckbox"),
    @NamedQuery(name = "Measure.findByNumber11installpoolpumpresult", query = "SELECT m FROM Measure m WHERE m.number11installpoolpumpresult = :number11installpoolpumpresult"),
    @NamedQuery(name = "Measure.findByNumber12installwholecheckbox", query = "SELECT m FROM Measure m WHERE m.number12installwholecheckbox = :number12installwholecheckbox"),
    @NamedQuery(name = "Measure.findByNumber12installwholehoint", query = "SELECT m FROM Measure m WHERE m.number12installwholehoint = :number12installwholehoint"),
    @NamedQuery(name = "Measure.findByNumber12installwholehoresult", query = "SELECT m FROM Measure m WHERE m.number12installwholehoresult = :number12installwholehoresult"),
    @NamedQuery(name = "Measure.findByNumber13installwacheckbox", query = "SELECT m FROM Measure m WHERE m.number13installwacheckbox = :number13installwacheckbox"),
    @NamedQuery(name = "Measure.findByNumber13installwaterhedouble", query = "SELECT m FROM Measure m WHERE m.number13installwaterhedouble = :number13installwaterhedouble"),
    @NamedQuery(name = "Measure.findByNumber13installwaresult", query = "SELECT m FROM Measure m WHERE m.number13installwaresult = :number13installwaresult"),
    @NamedQuery(name = "Measure.findByNumber14permitscheckbox", query = "SELECT m FROM Measure m WHERE m.number14permitscheckbox = :number14permitscheckbox"),
    @NamedQuery(name = "Measure.findByNumber14permitsresult", query = "SELECT m FROM Measure m WHERE m.number14permitsresult = :number14permitsresult"),
    @NamedQuery(name = "Measure.findByNumber15installbatterycheckbox", query = "SELECT m FROM Measure m WHERE m.number15installbatterycheckbox = :number15installbatterycheckbox"),
    @NamedQuery(name = "Measure.findByNumber15installbaresult", query = "SELECT m FROM Measure m WHERE m.number15installbaresult = :number15installbaresult"),
    @NamedQuery(name = "Measure.findByNumber15ainstallkwdcsocheckbox", query = "SELECT m FROM Measure m WHERE m.number15ainstallkwdcsocheckbox = :number15ainstallkwdcsocheckbox"),
    @NamedQuery(name = "Measure.findByNumber15ainstallkwdcsoint", query = "SELECT m FROM Measure m WHERE m.number15ainstallkwdcsoint = :number15ainstallkwdcsoint"),
    @NamedQuery(name = "Measure.findByNumber15bincludesexcheckbox", query = "SELECT m FROM Measure m WHERE m.number15bincludesexcheckbox = :number15bincludesexcheckbox"),
    @NamedQuery(name = "Measure.findByNumber15csolarcheckbox", query = "SELECT m FROM Measure m WHERE m.number15csolarcheckbox = :number15csolarcheckbox"),
    @NamedQuery(name = "Measure.findByNumber15dincludessycheckbox", query = "SELECT m FROM Measure m WHERE m.number15dincludessycheckbox = :number15dincludessycheckbox"),
    @NamedQuery(name = "Measure.findByNumber15eicheckbox", query = "SELECT m FROM Measure m WHERE m.number15eicheckbox = :number15eicheckbox"),
    @NamedQuery(name = "Measure.findByNumber15fcanadiansocheckbox", query = "SELECT m FROM Measure m WHERE m.number15fcanadiansocheckbox = :number15fcanadiansocheckbox"),
    @NamedQuery(name = "Measure.findByWholecost", query = "SELECT m FROM Measure m WHERE m.wholecost = :wholecost"),
    @NamedQuery(name = "Measure.findBySolarcost", query = "SELECT m FROM Measure m WHERE m.solarcost = :solarcost")})
